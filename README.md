...
# 2. Use a script to get a list of all my hashtags/topics
# 3. Use a script to find all files containing that hashtag, or even the line of the file.
# 4. Easily browse the search results to find what interests me or look for themes.
